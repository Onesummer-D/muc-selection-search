...
- 证据：evidence/week1/C/task0_fts5_trigram_output.md；task1_storage_tests_output.md；task2_api_frontend_evidence.md；task3_llm_evidence.md；task3_perf_p1_evidence.md；task4_release_evidence.md（含视口截图 3 张与待办清单）。
